...
#path to executable
exec=/sw/hprc/sw/dor-hprc-tools-tamulauncher/src/tamulauncher-loadbalanced.x

#path to log file
tamulauncherlog=/sw/hprc/sw/dor-hprc-tools-tamulauncher/log/tamulauncher.log
...
function write_mod_log()
{
	...
	if [ -z "$jobid" ]; then
	   ...
	   jobname=None
        ...
        for mod in /sw/eb/sw/GCCcore/13.2.0 /sw/eb/sw/impi/2021.10.0-intel-compilers-2023.2.1 ; do
